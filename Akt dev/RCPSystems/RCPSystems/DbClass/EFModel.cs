namespace RCPSystems
{
    ...
    public partial class EFModel : DbContext
    {
        ...
        public virtual DbSet<rcpUserHarmoList> rcpUserHarmoLists { get; set; }
        public virtual DbSet<sysdiagram> sysdiagrams { get; set; }
        public virtual DbSet<zadClient> zadClients { get; set; }
        public virtual DbSet<zadDuty> zadDuties { get; set; }
        ...
        public virtual DbSet<zadUserDuty> zadUserDuties { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<genUser>()
                .HasMany(e => e.rcpTransactionAlls)
                .WithRequired(e => e.genUser)
                .WillCascadeOnDelete(false);
