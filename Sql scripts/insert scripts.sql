declare @wzor as varchar(23),@wzor2 as varchar(23), @data as varchar(23),@data2 as varchar(23),@trans as int,@dzien as int,
@prac as int
set @dzien=0
...
DECLARE @StartDate DATE = '20170101', @NumberOfYears INT = 5;
